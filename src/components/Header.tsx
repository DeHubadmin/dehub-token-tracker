...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full relative">
      <div className="py-4 mx-auto max-w-7xl px-4 md:px-[70px]">
    ...
    <>
      {links.map(link => (
        <Button 
          ...
          size={buttonSize} 
          className={cn("text-white border-slate-700 hover:bg-slate-800 hover:text-white transition-all", buttonClass)} 
          asChild
        >
